    ...
    <?php
      for($i=0;$i<count($catalogo);$i++){
        echo "<div class=libro>
                ...
                "<p>"."<a class=textb href=/gestionLibros/delete/".$catalogo[$i]["ISBN"]."><button class=dell >BORRAR</button></a>"."</p></div><br>";
      }
    ?>
  </div>
  <div class="bAdd" > 
<a class="textb" href="/addLibro"><button class="addl" >NUEVO+</button></a>  
  </div>
